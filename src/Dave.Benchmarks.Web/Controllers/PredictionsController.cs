...
public class PredictionsController : ControllerBase
{
        ...
        [FromBody] CreateVariableRequest request)
    {
        ...
        // TODO: improve matching logic. String comparison on description isn't
        // really ideal on multiple levels.
        // 1. Should daily LAI and annual LAI be considered the same variable?
        // 2. Description is a user-facing string and not robust for matching
        // 3. String comparison is inefficient and doesn't scale well
        Variable? variable = dataset.Variables
